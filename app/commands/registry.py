...
COMMANDS: dict[str, CommandHandler] = {
    ...
    "open_run_dialog": lambda _arg: win.run_dialog(),
    "open_clipboard_history": lambda _arg: win.clipboard_history(),
    "take_screenshot": lambda _arg: win.screenshot_to_desktop(),
